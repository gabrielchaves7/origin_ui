...
void main() {
  testWidgets('Financial wellness form status should be invalid if annual income is empty', (tester) async {
    ...
    expect(financialWellnessForm.annualIncomeInput.status, equals(FormzInputStatus.invalid));
    expect(financialWellnessForm.monthlyCostsInput.status, equals(FormzInputStatus.valid));
  });

  testWidgets('Financial wellness form status should be invalid if annual income is zero', (tester) async {
    final financialWellnessForm = FinancialWellnessForm(
    ...
    expect(financialWellnessForm.status, equals(FormzStatus.invalid));
    expect(financialWellnessForm.annualIncomeInput.status, equals(FormzInputStatus.valid));
    expect(financialWellnessForm.monthlyCostsInput.status, equals(FormzInputStatus.invalid));
  });

  testWidgets('Financial wellness form status should be invalid if monthly costs is empty', (tester) async {
    final financialWellnessForm = FinancialWellnessForm(
      annualIncomeInput: const AnnualIncomeInput.dirty(value: '1000'),
  ...
  testWidgets('Financial wellness form status should be invalid if monthly costs is zero', (tester) async {
    final financialWellnessForm = FinancialWellnessForm(
      annualIncomeInput: const AnnualIncomeInput.dirty(value: '1000'),
      monthlyCostsInput: const MonthlyCostsInput.dirty(value: '0'),
    );
  ...
  testWidgets('Financial wellness form status should be valid if annual income and monthly costs are valid',
      (tester) async {
    final financialWellnessForm = FinancialWellnessForm(
