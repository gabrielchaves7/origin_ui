...
void main() {
  testWidgets('Formz status should be invalid if monthly income is empty',
      (tester) async {
  ...
  testWidgets('Formz status should be invalid if monthly income is 0',
      (tester) async {
  ...
  testWidgets(
      'Formz status should be valid if monthly income is greater than 0',
      (tester) async {
